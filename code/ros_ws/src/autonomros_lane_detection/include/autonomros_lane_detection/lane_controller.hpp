// Copied from https://github.com/ros-planning/navigation2/blob/galactic/nav2_regulated_pure_pursuit_controller/include/nav2_regulated_pure_pursuit_controller/regulated_pure_pursuit_controller.hpp
// Adapted
...
#ifndef AUTONOMROS_LANE_DETECTION__LANE_CONTROLLER_HPP_
#define AUTONOMROS_LANE_DETECTION__LANE_CONTROLLER_HPP_
 ...
 */
class LaneController : public nav2_core::Controller
{
public:
  /**
   * @brief Constructor for LaneController
   */
  LaneController() = default;

  /**
   * @brief Destrructor for LaneController
   */
  ~LaneController() override = default;
  ...
  void setLane(const iceoryx_msg::msg::LanePoints::SharedPtr point_cloud);
...
protected:
   ...
   */
  geometry_msgs::msg::PoseStamped getLookAheadPoint(const double &);
  ...
  iceoryx_msg::msg::LanePoints point_cloud_;

  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>> global_path_pub_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::PointStamped>>
  carrot_pub_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>> carrot_arc_pub_;
  rclcpp::Subscription<iceoryx_msg::msg::LanePoints>::SharedPtr lane_sub_;
};
}  // namespace autonomros_lane_detection

#endif  // AUTONOMROS_LANE_DETECTION__LANE_CONTROLLER_HPP_
